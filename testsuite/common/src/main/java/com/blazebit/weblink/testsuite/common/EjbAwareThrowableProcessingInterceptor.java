...
public class EjbAwareThrowableProcessingInterceptor<E extends Exception> extends ExceptionProcessingInterceptor<E> {
    ...
    private static final Class<? extends Throwable>[] UNWRAP_WITH_CORE = (Class<? extends Throwable>[]) new Class<?>[]{InvocationTargetException.class, EJBException.class, RollbackException.class, WeblinkException.class};
    @SuppressWarnings("unchecked")
    ...
    public EjbAwareThrowableProcessingInterceptor(Object target, Class<E> clazz) {
        ...
        unwraps = WeblinkException.class.isAssignableFrom(clazz) ? UNWRAP_WITHOUT_CORE : UNWRAP_WITH_CORE;
    }
